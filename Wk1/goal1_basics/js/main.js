 ...
 */
 ...
 STUDENT ACTIVITY 1:
    ...
    ********************************************/
    var  myArr2 = [10,50,100,200];
    console.log("total",myArr2[0]+ myArr2[1]+ myArr2[2]+ myArr2[3]);
 ...
 ********************************************/
   var myArr2 = new Array();
    ...
    console.log ("sports: ",myArr2[0] + ", ",myArr2[1]+", ",myArr2[2]);
 ...
 */
 ...
 // ture: run code
  ...
  //false run code:
   console.log("if-else: 'IF' statement is false");
  };
 ...
 */
    ...
    if(!(1 ===1)|| ("hi" === "no") ){
        console.log("NOT logical operator: left is true conveted to not");
    }else{
...
console.log("bob feels ",bobsMood);
...
var myFun = myCounter(5);
console.log("counter = ",myFun);
var myFun = myCounter(2);
console.log("counter = ",myFun);
 ...
 ********************************************/
    ...
    var moodFn = function(weather,waves){
        ...
        var moodType = moodFn(val1,val2);
            console.log("bob's new mood is",moodType);